// <script>
      ...
      function saveFormData() {
          ...
          formData.signupEmail = document.getElementById("signupEmail").value;
          formData.signupPassword = document.getElementById("signupPassword").value;
          formData.group = document.getElementById("group").value;
          formData.termsCheckbox = document.getElementById("termsCheckbox").checked;
      }
      
      // Load form data from variables
